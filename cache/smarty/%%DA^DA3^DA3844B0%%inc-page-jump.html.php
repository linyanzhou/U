<?php /* Smarty version 2.6.26, created on 2014-01-10 03:26:21
         compiled from ./Share/inc-page-jump.html */ ?>
Gesamtsumme: <?php echo $this->_tpl_vars['pw_rec_total']; ?>
&nbsp;&nbsp;
Seite: <?php echo $this->_tpl_vars['pw_curr_page']; ?>
/<?php echo $this->_tpl_vars['pw_page_total']; ?>
&nbsp;&nbsp;
...
?>
  <?php if ($this->_tpl_vars['pw_page_loop'][$this->_sections['sec']['index']]['is_curr']): ?>
    <a class="active" title="<?php echo $this->_tpl_vars['pw_url_prefix']; ?>
<?php echo $this->_tpl_vars['pw_page_loop'][$this->_sections['sec']['index']]['page_idx']; ?>
<?php echo $this->_tpl_vars['pw_url_suffix']; ?>
"><?php echo $this->_tpl_vars['pw_page_loop'][$this->_sections['sec']['index']]['page_idx']; ?>
</a><?php else: ?><a href='<?php echo $this->_tpl_vars['pw_url_prefix']; ?>
<?php echo $this->_tpl_vars['pw_page_loop'][$this->_sections['sec']['index']]['page_idx']; ?>
<?php echo $this->_tpl_vars['pw_url_suffix']; ?>
'><?php echo $this->_tpl_vars['pw_page_loop'][$this->_sections['sec']['index']]['page_idx']; ?>
</a><?php endif; ?>
