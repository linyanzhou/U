    ...
    class M_sell_de extends Model
    {
        ...
        { 
          ...
          //  $config_category = $this->get_datebase_config('category_en');
            $this->_table  = isset($config['sell_de']['table']) ? $config['sell_de']['table'] : null;
            $this->_fields = isset($config['sell_de']['fields']) ? $config['sell_de']['fields'] : null;
            $this->_select_units = isset($config['sell_de']['select_units']) ? $config['sell_de']['select_units'] : null;
